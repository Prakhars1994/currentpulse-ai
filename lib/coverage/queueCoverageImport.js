      ...
      try {
        ...
        return {
          ...
          ...(!shouldPublishImmediately
            ? {
                deferredReason: withinImmediateCap
                  ? "Immediate publishing time budget reached."
                  : "Immediate publishing per-run cap reached.",
              }
            : {}),
        };
      } catch (error) {
