...
const HARD_TITLE_PATTERNS = [
  ...
  /^(?:economy|polity|governance|environment|geography|history|culture|science|technology|social justice)(?:\s*\/\s*(?:economy|polity|governance|environment|geography|history|culture|science|technology|social justice))+$/i,
