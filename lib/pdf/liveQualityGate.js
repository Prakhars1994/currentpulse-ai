export const CA_PDF_LIVE_QUALITY_GATE_VERSION = 3;
...
export function auditCaPdfLiveArticle(markdown = "") {
  ...
  // ArticleContent promotes some prose labels containing section-like words into
  // headings. Reject those labels at import time so the live reader never gets
  // empty bullets/phantom headings such as “Consumer lens” or “System challenge”.
