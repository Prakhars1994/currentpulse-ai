...
const HIGHLIGHT_PATTERNS = [
  ...
  // Useful all-caps acronyms such as BNSS, BNS, UPI, GDP, PLI, BIMSTEC and compound forms such as ICAR-ICRISAT.
...
export function highlightMarkdownFacts(value = "") {
  ...
  // Never insert emphasis inside Markdown links, autolinks, inline code or existing emphasis.
  // Doing so can corrupt link syntax or leave raw ** fragments in the public reader.
