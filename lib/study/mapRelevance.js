...
export function isMapRelevantArticle({ title = "", category = "", text = "", mapLocations = [] } = {}) {
  ...
  // A real named state/city/country is itself a useful locator even when the
  // story is classified as Economy, Society, Science or another non-geo desk.
  if (nonGenericLocations.length > 0) return true;
