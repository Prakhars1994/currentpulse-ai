...
const TAXONOMY_OVERRIDES = [
  {
    pattern: /\b(?:vultures?|wildlife sanctuary|national park|tiger reserve|biosphere reserve|endangered species|critically endangered|species conservation|wildlife conservation)\b/i,
