...
const CATEGORY_TERMS = {
  ...
  "Science & Technology": ["science", "technology", "space", "isro", "satellite", "artificial intelligence", "quantum", "semiconductor", "biotech", "biotechnology", "genetics", "genetic", "genome", "genomic", "dna", "epigenetic", "nanotechnology", "robotics", "digital public infrastructure", "cyber technology"],
  Environment: ["environment", "climate", "ecology", "biodiversity", "pollution", "conservation", "forest", "wildlife", "species", "endangered", "migratory bird", "bird sanctuary", "black-necked crane", "avian species", "emission", "renewable", "wetland"],
  "Defence & Security": ["defence", "defense", "military", "armed forces", "military exercise", "joint exercise", "air exercise", "naval exercise", "terror", "insurgency", "border security", "missile", "navy", "air force", "cybersecurity"],
  "Social Issues": ["society", "social", "health", "education", "women", "gender", "poverty", "nutrition", "caste", "tribal", "employment", "inequality", "organ transplant", "transplantation", "notto"],
  Geography: ["geography", "river", "ocean", "mountain", "earthquake", "cyclone", "monsoon", "glacier", "volcano", "landslide"],
  "History & Culture": ["history", "culture", "heritage", "archaeology", "ancient", "medieval", "museum", "temple", "unesco", "civilisation", "civilization", "handloom", "handicraft", "traditional weaving", "textile heritage"],
...
const TAXONOMY_OVERRIDES = [
  {
    pattern: /\b(?:vultures?|clouded leopard|black[- ]necked crane|migratory birds?|bird sanctuary|avian species|wildlife sanctuary|national park|tiger reserve|biosphere reserve|endangered species|critically endangered|species conservation|wildlife conservation)\b/i,
    category: "Environment",
    paper: "GS-3",
  },
  {
    pattern: /\b(?:exercise pitch black|military exercise|joint military exercise|joint exercise|air exercise|naval exercise|multinational air exercise|tri-service exercise|war game|wargame)\b/i,
    category: "Defence & Security",
    paper: "GS-3",
  },
  {
    pattern: /\b(?:handloom|handicraft|traditional weaving|weaving tradition|textile heritage|national handloom day)\b/i,
    category: "History & Culture",
    paper: "GS-1",
  },
  {
    pattern: /\b(?:notto|e-pratyaropan|organ transplant(?:ation)?|organ donation|transplant registry)\b/i,
