...

{
  ...
  { id: "hindustan-times", name: "Hindustan Times", group: "indian-news", domain: "hindustantimes.com", region: "IN" },
  { id: "new-indian-express", name: "The New Indian Express", group: "state-news", domain: "newindianexpress.com", region: "IN", queryTerms: ["India states politics economy society when:2d"] },
  ...
  { id: "al-jazeera", name: "Al Jazeera", group: "global-news", domain: "aljazeera.com", region: "WORLD" },
...
export const GENERAL_NEWS_QUERY_TERMS = [
  "national politics government courts economy society",
  "states cities infrastructure crime weather disaster",
  "business markets companies technology science health education",
  "sports culture arts media major events",
  "world international conflict diplomacy economy climate",
];
