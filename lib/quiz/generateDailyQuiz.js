...
function sourcePayload(articles) {
  return articles.map((article) => ({
    ...
    syllabusLinkage: cleanText(article.syllabus_linkage, 700),
    indiaRelevance: cleanText(article.india_relevance, 800),
    staticFoundation: cleanText(article.static_foundation, 2400),
    dataReportsCasesExamples: cleanText(article.data_examples, 2200),
    prelimsFacts: cleanText(article.prelims, 2200),
    mainsContext: cleanText(article.mains, 1400),
  }));
}
