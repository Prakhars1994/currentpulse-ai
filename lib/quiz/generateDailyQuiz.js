...
export async function generateDailyQuiz(supabase, { force = false } = {}) {
  ...
  const { data: articles, error: articlesError } = await supabase
    .from("articles")
    .select("id,title,slug,category,why_news,syllabus_linkage,india_relevance,static_foundation,data_examples,prelims,mains,quality_score,quality_version,created_at,article_sources!inner(source_kind)")
    .eq("status", "published")
