...
const mainsPapers2012To2026=[...papers2026,...MAINS_GENERAL_STUDIES_LIBRARY.filter(item=>item.year>=2012)];

export default function PyqPage() {
  return <main className="pyq-page-theme min-h-screen px-6 py-14 text-white"><div className="mx-auto max-w-5xl">
    <p className="font-bold uppercase tracking-[0.24em] text-amber-300">Question-led revision</p><h1 className="mt-3 text-4xl font-black sm:text-5xl">UPSC Mains PYQ explorer</h1><p className="mt-4 max-w-3xl text-lg leading-8 text-slate-400">Open General Studies paper access for the 15 examination years from 2012 through 2026, then use the smaller annotated theme bank for answer-writing practice. The 2026 entries point to UPSC's official previous-question-paper page rather than guessing PDF filenames.</p>
    <div className="mt-10"><MainsPaperNavigator papers={mainsPapers2012To2026}/></div>
